  ...
  return (
    <>
      <Routes>
          ...
          <Route path="/privacy-policy" element={<PublicElement><PrivacyPolicy /></PublicElement>} />
          <Route path="/tnc" element={<PublicElement><TnC /></PublicElement>} />
          <Route path="/contact-us" element={<PublicElement><ContactUs /></PublicElement>} />
          <Route path="/message" element={<UserElement><AllMessage /></UserElement>} />
          <Route path="/forgot-password" element={<PublicElement><Forgot_Password /></PublicElement>} />
          <Route path="/cancellation-refund-policy" element={<PublicElement><CancellationRefundPolicy /></PublicElement>} />
          ...
          <Route path="/VWindow" element={<UserElement><VideoWindow /></UserElement>} />
